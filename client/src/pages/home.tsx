        ...
        <div className="relative z-10 text-center px-4 max-w-4xl mx-auto">
          <h1 className="text-5xl md:text-7xl font-bold uppercase tracking-wider mb-6 drop-shadow-2xl">
            {heroTitle.startsWith("CB") ? (
              <>
                <span style={{ background: "linear-gradient(180deg, #c8c8c8 0%, #777 45%, #aaa 100%)", WebkitBackgroundClip: "text", WebkitTextFillColor: "transparent", filter: "drop-shadow(0 0 4px rgba(255,255,255,0.45)) drop-shadow(0 2px 6px rgba(0,0,0,0.9))" }}>C</span>
