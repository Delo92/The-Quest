...
const LIVERY_DEFAULTS = [
  ...
  { imageKey: "why_subtitle", label: "Why HiFitComp - Subtitle", defaultUrl: "", itemType: "text" as const, defaultText: "See what's new" },
  { imageKey: "why_heading", label: "Why HiFitComp - Section Heading", defaultUrl: "", itemType: "text" as const, defaultText: "Why HiFitComp" },
  { imageKey: "why_card1_title", label: "Why HiFitComp - Card 1 Title", defaultUrl: "", itemType: "text" as const, defaultText: "Any Competition" },
  { imageKey: "why_card1_desc", label: "Why HiFitComp - Card 1 Description", defaultUrl: "", itemType: "text" as const, defaultText: "Music, modeling, bodybuilding, dance, art -- create or join competitions in any talent category imaginable." },
  { imageKey: "why_card2_title", label: "Why HiFitComp - Card 2 Title", defaultUrl: "", itemType: "text" as const, defaultText: "Public Voting" },
  { imageKey: "why_card2_desc", label: "Why HiFitComp - Card 2 Description", defaultUrl: "", itemType: "text" as const, defaultText: "Fair, transparent voting. The public decides who wins with configurable vote limits and pricing per competition." },
  { imageKey: "why_card3_title", label: "Why HiFitComp - Card 3 Title", defaultUrl: "", itemType: "text" as const, defaultText: "Rich Profiles" },
  { imageKey: "why_card3_desc", label: "Why HiFitComp - Card 3 Description", defaultUrl: "", itemType: "text" as const, defaultText: "Upload photos, videos, share your bio and social links. Build a stunning profile that shows the world your talent." },
